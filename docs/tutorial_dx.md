Tutorial for DNANexus Platform
===================================================
...
4. Create a [Google Project](https://console.developers.google.com/project) `[YOUR_PROJECT_NAME]` and choose it on the top of the page. You will be asked to 
...
11. It will take about an hour. You will be able to find all outputs on your Google Cloud bucket. Final QC report/JSON will be stored on `gs://[YOUR_BUCKET_NAME]/ENCSR356KRQ_subsampled/atac/[SOME_HASH_STRING]/call-qc_report/execution/glob*/qc.html` or `qc.json`.

12. See full specification for [input JSON file](input.md) and [output directory structure](output.md).
