        ...
        stages {
                ...
                stage('Build-nonmaster') {
                        ...
                        steps { 
                                ...
                                sh "docker pull quay.io/encode-dcc/atac-seq-pipeline:v1.1.2"
                                sh "docker login -u=${QUAY_USER} -p=${QUAY_PASS} quay.io"
                                sh "docker build --cache-from quay.io/encode-dcc/atac-seq-pipeline:v1.1.2 -f docker_image/Dockerfile -t atac-seq-pipeline ."
