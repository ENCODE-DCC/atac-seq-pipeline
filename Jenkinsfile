        ...
        stages {
                ...
                stage('Build-nonmaster') {
                        ...
                        steps { 
                                ...
                                sh "docker pull quay.io/encode-dcc/atac-seq-pipeline:latest"
                                sh "docker login -u=${QUAY_USER} -p=${QUAY_PASS} quay.io"
                                sh "docker build --cache-from quay.io/encode-dcc/atac-seq-pipeline:latest -f docker_image/Dockerfile -t atac-seq-pipeline ."
